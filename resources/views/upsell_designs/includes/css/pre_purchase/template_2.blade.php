@include('upsell_designs.includes.css.pre_purchase.common_css') /* include Common CSS*/


.aus-t2-main-container-wrapper  {
    display: none;
...
.reset-t2.aus-t2-main-container.aus-t2-main-container-2{
...
.reset-t2.aus-t2-main-container{
  ...
  shape-outside: none v !important;
...
@media (min-width: 320px) and (max-width: 480px){
  ...
  .reset-t2.aus-tp-2-img.aus-tp-2-img-resp{
    width: 16% !important;
  ...
  .reset-t2.aus-tp-2-right-div.aus-tp-2-right-div-resp{
  ...
  .reset-t2.aus-t2-timer-colon.aus-t2-timer-colon-resp{
    font-size : 13px !important;
...
.reset-t2.aus-tp-2-counter{
    border: .5px solid #8dd7be !important;
...
.reset-t2.aus-total-tp-2{
    font-size: 25px !important;
    color: {{$upsell->setting['t2-total-price-color']}}!important;
    font-weight: bold !important;
...
.reset-t2.aus-tp-2-price-fig{
    color: {{$upsell->setting['t2-price-color']}} !important;
    font-size: 23px !important;
    font-weight: bold !important;
...
.reset-t2.aus-tp-2-checkout-btn{
    ...
    border: .5px solid {{$upsell->setting['alpha_t2_checkout_btn_border_color']}} !important;
...
.reset-t2.aus-t2-last-portion{
  margin: 2px 17px !important;



}
.reset-t2.aus-t2-item-box{
    position: relative !important;
    margin: 25px 5px !important;
}

.reset-t2.aus-t2-last-portion-img-div{
...
.reset-t2.aus-t2-lp-offer-badge{
    display : inline !important;
    font-size: 15px !important;
...
.reset-t2.aus-t2-lp-variant{
    display: flex !important;
    margin-top: 5px !important;
}


.reset-t2.aus-t2-variant-selector{
...
.reset-t2.aus-t2-footer{
   display: flex !important;
   justify-content: center !important;

}

.reset-t2.aus-t2-footer-btn{
    font-size: 20px !important;
    border-radius: 25px !important;
    color: {{$upsell->setting['alpha_t2_no_thanks_btn_color']}} !important;
    border: .5px solid {{$upsell->setting['alpha_t2_no_thanks_btn_border_color']}} !important;
    padding: 15px 20px !important;
    cursor: pointer !important;
