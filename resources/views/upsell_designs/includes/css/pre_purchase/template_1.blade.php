...
.reset-t1.aus-t1-main-container{
...
/*  Font family */
  ...
  .reset-t1.aus-t1-top-container-content{
    margin: 2px 5px !important;


  }

  .reset-t1.aus-t1-tick-emoji{
  ...
  .reset-t1.aus-t1-top-container-text{
  ...
  .reset-t1.aus-t1-below-top-container{
    display: flex !important;
    justify-content: flex-start !important;
    position: relative !important;
  ...
  .reset-t1.aus-t1-below-top-2{
    display : flex !important;
    width : 100% !important;
  }


  .reset-t1.aus-t1-cross-btn{
  ...
  .reset-t1.aus-t1-below-top-2-content{
    display: inline !important;
    width: 100% !important;
  ...
  .reset-t1.aus-bt-2-total{
    color: {{$upsell-> setting['text-color-price-total'] }}!important;
  ...
  .reset-t1.aus-bt-2-price-fig{
    color: {{$upsell-> setting['price-color-figure'] }}!important;
    font-size : 22px !important;
    font-weight: bold !important;
  ...
  .reset-t1.aus-t1-below-top-line{
    display : block !important;
  ...
  .reset-t2.aus-mid-container-text{
  ...
  .reset-t1.aus-t1-lp-img{
    width: 90% !important;
  }


  .reset-t1.aus-t1-content-div{
    display: flex !important;
  ...
  .reset-t1.aus-t1-offer-badge{
    background-color:{{$upsell->setting['discount_background_color']}} !important;
  ...
  .reset-t1.aus-t1-atc-btn{
    background-color: {{$upsell->setting['button_background_color']}} !important;
  ...
  .reset-t1.aus-t1-item-box{
    display : inline-block !important;
    width: 30% !important;
    padding: 19px !important;
  }

  .reset-t1.aus-t1-last-portion{
    display: flex !important;
