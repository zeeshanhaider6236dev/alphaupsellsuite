...
.reset-t6.aus-t6-main-container.aus-t6-main-container-2{
...
.reset-t6.aus-t6-main-container *{
...
.reset-t6.aus-t6-mp-box:hover{
    box-shadow: 0 0 20px #9e9e9e !important;
    transition: 0.3s ease-in !important;

}

.reset-t6.aus-t6-mp-content-div{
    display: flex !important;
    flex-direction: column !important;
...
.reset-t6.aus-t6-mp-box-img-div{
    width: 53%  !important;
    height: auto !important;
    margin: 10px auto !important;
...
.reset-t6.aus-t6-mp-box-img{
    width: 100% !important;
    height: auto !important;
}

.reset-t6.aus-t6-mp-box-btn{
    ...
    cursor:pointer !important;
    border: 1px solid {{ $upsell->setting['alpha_t6_checkout_btn_border_color'] }} !important;
    margin: 10px 5px !important;
}

.reset-t6.aus-t6-mp-box-btn:hover{
    background-color: transparent !important;
...
.reset-t6.aus-t6-lp-box-div{
    display: inline-block !important;

}

.reset-t6.aus-t6-lp-box{
    display: inline-flex !important;
    flex-direction: column !important;
    margin: 20px !important;
    padding: 10px !important;
...
.reset-t6.aus-t6-ib-lp-content-div{
    display: flex !important;
    flex-direction: column !important;
...
.reset-t6.aus-t6-lp-ib-price-div{
    margin: 7px!important;
...
.reset-t6.aus-t6-atc-btn{
    ...
    padding: 8px  6px!important;
    text-align: center !important;
    border: 1px solid {{$upsell->setting['alpha_t6_btn_border_color']}}!important;
    cursor: pointer !important;
    margin: 7px !important;
...
.reset-t6.aus-t6-nts-btn{
    ...
    font-weight: 700 !important;
    background: {{ $upsell->setting['alpha_no_thanks_btn_bg_color'] }} !important;
    cursor: pointer !important;
    border: 0.5px solid {{ $upsell->setting['alpha_no_thanks_btn_border_color'] }} !important;
